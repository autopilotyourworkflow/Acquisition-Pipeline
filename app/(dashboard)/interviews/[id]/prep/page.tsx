...
export default async function InterviewPrepPage({
  ...
  // Latest score for this candidate/JD pair (where the prep questions live).
  const { data: latestScore } = await supabase
    .from("scores")
    .select(
      "id, weighted_total, skills_score, experience_score, culture_score, reasoning, strengths, gaps, prep_questions, hiring_report, model, scoring_mode, created_at",
    )
      ...
      {prepQuestions.length > 0 ? (
        <section className="rounded-lg border border-sand-200 bg-warm-white p-5">
          ...
          <p className="mt-1 text-xs text-slate-deep">
            Generated by the screener against this JD. Use as a starting
            point — adapt to the conversation.
          </p>
